...
// IDENTITY
export const AI_NAME = "BITSPrep";               // short, clean, BITS-branded
...
// MODERATION MESSAGES (unchanged – still good)
...
// PINECONE CONFIG (RAG over your interview transcripts)
export const PINECONE_TOP_K = 20;            // 20 is enough for domain transcripts; you can keep 40 if you like
export const PINECONE_INDEX_NAME = "my-ai";  // keep this if you're using the same index; rename only if you create a new one
